...
app.use(
    cors({
      origin: ["https://whatsapp.limpiolux.com:7129", "https://whatsapp.limpiolux.com:7130", "https://whatsapp.limpiolux.com:7131", "https://whatsapp.limpiolux.com:7132", "https://whatsapp.limpiolux.com:7134", "https://whatsapp.limpiolux.com"],
      methods: ["GET", "POST"],
      allowedHeaders: ["Content-Type"],
    })
  );
  server.listen(port, () => {
    console.log(`Aplicación HTTP para saber el número registrado en ${port}`);
  });
        ...
        try {
            ...
            sock.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'open') {
                    ...
                    const phoneNumber = baileyCleanNumber(parseNumber, true);
                    app.get('/phone-number', (req, res) => {
                        res.send(`${phoneNumber}`);
                    });
                    
                    console.log('Número registrado:', phoneNumber);
                }
